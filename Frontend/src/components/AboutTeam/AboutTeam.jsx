...
import leftArrow from '../../assets/aboutTeam/leftArrow.svg';
import people from '../../assets/aboutTeam/people.svg';
import rightArrow from '../../assets/aboutTeam/rightArrow.svg';
import Tajmahal from '../../assets/aboutTeam/Tajmahal.svg';
import TopArrow from '../../assets/aboutTeam/TopArrow.svg';
import Page from '../../assets/aboutTeam/Page.png'
import Pin from '../../assets/aboutTeam/Pin.png'

const StickyNote = ({ content, className = '' }) => {
    return (
        <motion.div
            className={`p-6 sm:p-8 md:p-10 rounded-lg shadow-xl relative w-full max-w-xs sm:max-w-sm md:max-w-md ${className}`}
            style={{
        ...
        >
            ...
            />
            {/* Pin decoration */}
            <div className="absolute -top-4 -right-4 sm:-top-5 sm:-right-5 md:-top-6 md:-right-5 z-10">
                <img
                    src={Pin}
                    alt="pin"
            ...
            <p className="text-brand-blue font-halant font-semibold leading-relaxed text-sm sm:text-base md:text-lg relative z-5">
                {content}
            </p>
        </motion.div>
    );
...
const TeamSection = () => {
    const roles = [
        ...
        },
        {
            title: 'Art Curators',
            arrow: rightArrow,
            position: 'top-8 sm:top-12 md:top-16 lg:top-19 -right-2 sm:-right-3 md:-right-3 lg:-right-3',
        ...
        },
        {
            ...
            arrow: leftArrow,
            position: 'hidden lg:block -bottom-0 sm:-bottom-6 md:-bottom-8 lg:-bottom-10 -left-8 sm:-left-32 md:-left-40 lg:-left-60',
...
const AboutTeam = () => {
    ...
    return (
        <section className="relative min-h-screen py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 overflow-hidden">
            <div className="max-w-7xl mx-auto relative z-10">
                {/* Top Section with Sticky Note and Team */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center mb-0">
                    ...
                    >
                        <StickyNote content={aboutText} className="max-w-xs sm:max-w-sm md:max-w-md" />
                    </motion.div>
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center lg:items-start mt-4 sm:mt-6 md:mt-8 lg:mt-0 gap-8 sm:gap-10 md:gap-12">
                    {/* Decorative Monument Illustration - Left Half */}
                    <motion.div
                        className="w-full lg:w-1/2 relative left-0 sm:left-0 md:left-0 lg:-left-30 bottom-8 sm:bottom-12 md:bottom-16 lg:bottom-8 flex justify-center lg:justify-center"
                    ...
                    >
                        <h2 className="text-lg sm:text-xl md:text-2xl lg:text-2xl text-[#0F3255] font-halant font-medium mb-6 sm:mb-7 md:mb-8 lg:mb-8 max-w-3xl mx-auto leading-tight">
